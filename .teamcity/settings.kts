...
project {
    ...
    subProject(DslIdea_ProjectToBreak1)
}
...
object DslIdea_IdeaTest : BuildType({
    ...
    vcs {
        root(DslIdea_HttpUnit1413LabsIntelliJNetSvnIdea)
    }
...
object DslIdea_HttpUnit1413LabsIntelliJNetSvnIdea : SvnVcsRoot({
    id("HttpUnit1413LabsIntelliJNetSvnIdea")
...
object DslIdea_ProjectToBreak1 : Project({
    id("ProjectToBreak1")
